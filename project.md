...
- The Canadian government shut down the commercial cod industry with a cod moratorium in 1992 as a last resort option to save the cod population.
  - Chart: Same cod-population chart, but vertical event indicator of the cod moratorium in 1992.
  <img src="photos/newfoundland_cod_moratorium.png">
  - Cod is now "vulnerable to extinction" 
...
** Section added after the in-class critique

- The cod industry and Newfoundlanders are still in recovery.
  <img src="photos/newfoundland_cod_today.png">
...
- **Newfoundland economic impact metrics** <br><br>

  Newfoundland was its own country until 1949 when it joined Canada. Finding data on Newfoundland before it was a part of Canada can be hard. One metric that Canada uses to track long-term economic performance is household income per capita. I will be using this data to analyze the economic impact of joining Canada and the cod moratorium on Newfoundland. This data is not yet graphed in the story. Need to analyze it more to see if it adds to the narrative.<br><br>
...
- **Percent of labour force in fishery in Newfoundland**

  This dataset shows the percent of workers in Newfoundland who are fisherman. We can see that in the 1800s fishing was the primary occupation of workers and a majority part of the Newfoundland economy. <br><br>

  Roy, N. et al. (2006). _The fishery as economic base in the Newfoundland economy._IIFET 2006 Portsmouth Proceedings. <br><br>
